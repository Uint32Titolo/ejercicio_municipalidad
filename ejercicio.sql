...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-01-2022 a las 18:28:44
...
CREATE TABLE `candidatos` (
  ...
  `nombreApellido` text COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `candidatos` (`idCandidato`, `nombreApellido`) VALUES
(1, 'candidato 1'),
(2, 'candidato 2'),
(3, 'candidato 3'),
(4, 'candidato 4');
...
CREATE TABLE `ubicacion` (
  `idUbicacion` int(7) NOT NULL,
  `idVotacion` int(7) NOT NULL,
...
CREATE TABLE `votacion` (
  ...
  `ingreso` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `candidatos`
  MODIFY `idCandidato` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `ubicacion`
  MODIFY `idUbicacion` int(7) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `votacion`
--
ALTER TABLE `votacion`
  MODIFY `idVotacion` int(7) NOT NULL AUTO_INCREMENT;
COMMIT;
